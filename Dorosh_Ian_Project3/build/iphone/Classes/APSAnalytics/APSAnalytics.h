 ...
 * to send analytic data that can be viewed on the Dorosh_Ian_Project3 Dashboard.
 *
 * For information on getting started with Dorosh_Ian_Project3 Platform Services,
