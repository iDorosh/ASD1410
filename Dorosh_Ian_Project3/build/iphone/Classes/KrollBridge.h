...
@interface Dorosh_Ian_Project3Object : KrollCoverageObject {
#else
@interface Dorosh_Ian_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_Project3Object *_dorosh_ian_project3;
    KrollObject* console;
	BOOL shutdown;
