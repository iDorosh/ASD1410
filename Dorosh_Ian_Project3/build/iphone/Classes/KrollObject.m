...
//@interface Dorosh_Ian_Project3Object : NSObject
//@end

@interface Dorosh_Ian_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_Project3Object class]])
		{
			for (NSString *key in [[(Dorosh_Ian_Project3Object*)o modules] allKeys])
			{
