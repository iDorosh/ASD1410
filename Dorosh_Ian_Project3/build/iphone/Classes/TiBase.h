...
// in simulator we redefine to format for Dorosh_Ian_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_Project3NativeItemNone = -1, 
	UIDorosh_Ian_Project3NativeItemSpinner = -2,
	UIDorosh_Ian_Project3NativeItemProgressBar = -3,
	
	UIDorosh_Ian_Project3NativeItemSlider = -4,
	UIDorosh_Ian_Project3NativeItemSwitch = -5,
	UIDorosh_Ian_Project3NativeItemMultiButton = -6,
	UIDorosh_Ian_Project3NativeItemSegmented = -7,
	
	UIDorosh_Ian_Project3NativeItemTextView = -8,
	UIDorosh_Ian_Project3NativeItemTextField = -9,
	UIDorosh_Ian_Project3NativeItemSearchBar = -10,
	
	UIDorosh_Ian_Project3NativeItemPicker = -11,
	UIDorosh_Ian_Project3NativeItemDatePicker = -12,
	
	UIDorosh_Ian_Project3NativeItemInfoLight = -13,
	UIDorosh_Ian_Project3NativeItemInfoDark = -14,
	
	UIDorosh_Ian_Project3NativeItemDisclosure = -15,
	
	UIDorosh_Ian_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_Project3 instances of
