...
/**
 The base class for all Dorosh_Ian_Project3 modules
 */
...
/**
 Dorosh_Ian_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Dorosh_Ian_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Dorosh_Ian_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Dorosh_Ian_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Dorosh_Ian_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
