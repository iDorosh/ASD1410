...
@interface Dorosh_Ian_Project4Object : KrollCoverageObject {
#else
@interface Dorosh_Ian_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_Project4Object *_dorosh_ian_project4;
    KrollObject* console;
	BOOL shutdown;
