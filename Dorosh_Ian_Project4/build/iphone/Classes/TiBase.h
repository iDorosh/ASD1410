...
// in simulator we redefine to format for Dorosh_Ian_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_Project4NativeItemNone = -1, 
	UIDorosh_Ian_Project4NativeItemSpinner = -2,
	UIDorosh_Ian_Project4NativeItemProgressBar = -3,
	
	UIDorosh_Ian_Project4NativeItemSlider = -4,
	UIDorosh_Ian_Project4NativeItemSwitch = -5,
	UIDorosh_Ian_Project4NativeItemMultiButton = -6,
	UIDorosh_Ian_Project4NativeItemSegmented = -7,
	
	UIDorosh_Ian_Project4NativeItemTextView = -8,
	UIDorosh_Ian_Project4NativeItemTextField = -9,
	UIDorosh_Ian_Project4NativeItemSearchBar = -10,
	
	UIDorosh_Ian_Project4NativeItemPicker = -11,
	UIDorosh_Ian_Project4NativeItemDatePicker = -12,
	
	UIDorosh_Ian_Project4NativeItemInfoLight = -13,
	UIDorosh_Ian_Project4NativeItemInfoDark = -14,
	
	UIDorosh_Ian_Project4NativeItemDisclosure = -15,
	
	UIDorosh_Ian_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_Project4 instances of
