...
//Rare exceptions to indicate a bug in the _dorosh_ian_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Dorosh_Ian_Project4 proxies.
 */
