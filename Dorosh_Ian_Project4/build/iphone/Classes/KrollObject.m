...
//@interface Dorosh_Ian_Project4Object : NSObject
//@end

@interface Dorosh_Ian_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_Project4Object class]])
		{
			for (NSString *key in [[(Dorosh_Ian_Project4Object*)o modules] allKeys])
			{
